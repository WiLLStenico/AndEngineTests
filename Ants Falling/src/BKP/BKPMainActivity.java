 ...
 * 
 */
public class BKPMainActivity extends SimpleBaseGameActivity {
	...
	private void initOnScreenControls() {
		final AnalogOnScreenControl analogOnScreenControl = new AnalogOnScreenControl(
			...
			public void onControlChange(final BaseOnScreenControl pBaseOnScreenControl, final float pValueX, final float pValueY) {
				...
				BKPMainActivity.this.helicopter.setRotation(MathUtils.radToDeg(rotationInRad));
				//BKPMainActivity.this.scene.setRotation(MathUtils.radToDeg(rotationInRad));
			}
